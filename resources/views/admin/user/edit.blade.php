...
<div class="row">
    ...
    <div class="col-12 col-md-9">
        <form class="card py-3" action="{{route('admin.user.update', $user)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="px-3 pt-4 pb-2">
                <div class="d-flex align-items-center">
                    ...
                    src="{{$user->image?->url ?? $DEFAULT_USER_IMG}}" alt="Mario Avatar">
                    <div>
